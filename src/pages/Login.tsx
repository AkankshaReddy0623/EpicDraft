    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center bg-gradient-to-br from-background-light via-white to-gray-50 dark:from-background-dark dark:via-gray-900 dark:to-gray-800 py-12 transition-colors duration-300">
      <div className="card max-w-md w-full mx-4 animate-bounce-in">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">Continue with Google to get started</p>
        </div>
        ...
        <button
          ...
          disabled={loading}
          className="btn-primary w-full mb-6 flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {loading ? (
        ...
        <div className="mt-6 text-center">
          <Link to="/" className="text-gold hover:text-gold-dark transition-colors text-sm">
            ← Back to home
          </Link>
        </div>
      </div>
